...
class BranchViewHolder(
    ...
    private val currentEventDatePlace: TextView = currentBranchEvent.findViewById(R.id.event_date_place_text_view)
    private val currentSpeakerName: TextView = currentBranchEvent.findViewById(R.id.speaker_name_text_view)
    private val currentSpeakerJob: TextView = currentBranchEvent.findViewById(R.id.speaker_job_text_view)
    private val currentEventTitle: TextView = currentBranchEvent.findViewById(R.id.event_title_text_view)

    private val nextEventDatePlace: TextView = nextBranchEvent.findViewById(R.id.event_date_place_text_view)
    private val nextSpeakerName: TextView = nextBranchEvent.findViewById(R.id.speaker_name_text_view)
    ...
    init {
        currentBranchEvent.findViewById<TextView>(R.id.next_event_text_view).visibility = View.INVISIBLE
    }
